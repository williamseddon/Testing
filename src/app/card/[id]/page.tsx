        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-5 grid place-items-center">
              <div className="relative h-[420px] w-[260px] overflow-hidden rounded-[28px] border border-black/10 bg-white/40 shadow-sm">
                <Image
                  src={card.image}
                  alt={card.title}
                  fill
            ...
            <div className="mt-6 flex items-center justify-between gap-2">
              ...
              <div className="text-xs text-black/45">PDF page {card.pdfPage}</div>
            </div>
          </div>
        </div>
