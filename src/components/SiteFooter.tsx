    ...
    <footer className="border-t border-black/5 bg-white/60">
      <Container className="py-10">
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="grid grid-cols-2 gap-6 text-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-black/60">
                <span className="block">{site.contact.website}</span>
                <span className="block">{site.contact.email}</span>
                <span className="block">{site.contact.social}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-black/5 pt-6 text-xs text-black/45 sm:flex-row sm:items-center sm:justify-between">
          <span>© {new Date().getFullYear()} {site.productName}. All rights reserved.</span>
